...
program5: program5.tab.c program5.tab.h program5_lex.cpp program5.cpp attributes.h node.hpp 
	${CXX} ${CXXFLAGS} program5.cpp program5.tab.c program5_lex.cpp attributes.cpp -o program5
